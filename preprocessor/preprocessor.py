...
class Preprocessor:
    ...
    def build_from_path(self):
        ...
        for wav_name in tqdm(os.listdir(os.path.join(self.in_dir, "wavs"))):
    ...
    def get_mel_from_audio(self, wav_path):
    ...
    def process_utterance(self, basename):
        ...
        text_path = os.path.join(self.in_dir, "wavs", "{}.txt".format(basename))
        tg_path = os.path.join(
            self.out_dir, "textgrid", "{}.TextGrid".format(basename)
        )
